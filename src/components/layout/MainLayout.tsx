            ...
            <AnimatePresence mode="wait">
                {isRightSidebarOpen && !isSignInPage && (
                    <motion.aside
                        ...
                        transition={{ duration: 0.3, ease: "easeInOut" }}
                        className="absolute top-0 right-0 h-full w-[320px] flex flex-col shrink-0 z-50 border-l border-white/5 shadow-2xl shadow-black/50"
                    >
                        <RightSidebar />
                    </motion.aside>
                )}

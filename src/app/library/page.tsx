...
import { ArrowLeft, Image as ImageIcon, Trash2, RefreshCw } from 'lucide-react';
    ...
    const fetchImages = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Library images fetched
                setImages(data.images);
            } else {
                console.error("Failed to fetch library images:", res.status);
            }
        } catch (error) {
                ...
                <div className="max-w-7xl mx-auto pb-12">
                    {loading ? (
                        ...
                        <MasonryGrid
                            ...
                            gap={16}
                            renderItem={(img) => (
                                <div key={img.id} className="group relative bg-white/5 rounded-xl overflow-hidden border border-white/5 hover:border-purple-500/50 transition-colors">
                                    <Image
                                        src={img.imageUrl}
                                        alt={`Upload ${img.id}`}
